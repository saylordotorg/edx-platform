...
* To change the grade, use the mouse pointer to select the grade. Then type the new grade, replacing the old grade.You can use any string to indicate a grade. For example, you can change **A** to **Excellent**.

  You cannot change **F**, **Pass**, or **Fail**. 
